...
export default function FAQ() {
  return (
    <div className="min-h-screen bg-umgBlue text-white flex flex-col items-center px-4 py-10">
      <div className="max-w-3xl w-full bg-white text-slate-800 rounded-2xl shadow-soft p-8">
        <h2 className="text-3xl font-bold text-umgBlue text-center mb-6">
        ...
        <details className="group border border-slate-200 rounded-xl p-4 mb-4 hover:shadow-md transition">
          ...
          <p className="mt-2 text-slate-700">
            Completa el formulario con tus datos y recibirás un correo de
            confirmación.
          </p>
        </details>
        ...
        <details className="group border border-slate-200 rounded-xl p-4 mb-4 hover:shadow-md transition">
          ...
          <p className="mt-2 text-slate-700">
            Sí, siempre que haya cupo disponible y los horarios no se crucen.
          </p>
        </details>
        ...
        <details className="group border border-slate-200 rounded-xl p-4 hover:shadow-md transition">
          ...
          <p className="mt-2 text-slate-700">
            Se te enviará un código QR; al ingresar al evento lo escaneas para
